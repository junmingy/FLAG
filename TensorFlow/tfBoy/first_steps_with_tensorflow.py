...
def train_model(learning_rate, steps, batch_size, input_feature="total_rooms"):
    ...
    :param steps: A none-zero int, the total number of training steps. A training
                  step consist of a forward and backward pass using a single batch
    :param batch_size: A none-zero int, the batch size
...
# Train model
train_model(learning_rate=0.00001, steps=1000, batch_size=10)

print("")

# Train model with 'population' feature
train_model(learning_rate=0.00001, steps=1000, batch_size=10, input_feature='population')
