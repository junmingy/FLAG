...
def construct_feature_columns():
    ...
    bucketized_house_median_age = tf.feature_column.bucketized_column(
        tf.feature_column.numeric_column("house_median_age"),
        boundaries=get_quantile_based_buckets(training_examples["house_median_age"], 10)
    )
    ...
    bucketized_total_bedrooms = tf.feature_column.numeric_column(
